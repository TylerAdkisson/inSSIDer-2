...
namespace inSSIDer.Scanning
{
    public class NetworkDataCacheN
    {
        ...
        /// </summary>
        public int Count { get { return GetAccessPoints().Length; } }

        /// <summary>
        /// Get the total number of APs in the cache
        /// </summary>
        public int TotalCount { get { return _cache.Count; } }
        ...
        /// </summary>
        private void OnFilterChanged() { if (FiltersChanged != null) FiltersChanged(this, EventArgs.Empty); }

        /// <summary>
        /// Fire the DataReset event if it's hooked
        /// </summary>
        private void OnDataReset() { if (DataReset != null) DataReset(this, EventArgs.Empty); }
